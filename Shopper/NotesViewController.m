    ...
    if (self) {
      ...
      AppDelegate *pDlg = (AppDelegate *)[[UIApplication sharedApplication] delegate];
        if ([pAddEditCntrl isKindOfClass:[AddViewController class]])
        {
            ...
            if (pAddCntrl.pNewItem.notes !=nil && [pAddCntrl.pNewItem.notes length] >0)
            {
                notes.text = pAddCntrl.pNewItem.notes;
        ...
        {
            if (pDlg.editItem.notes !=nil && [pDlg.editItem.notes length] >0)
            {
                notes.text = pDlg.editItem.notes;
                NSLog(@"Notes set to %@", notes.text);
...
- (void)textViewDidChange:(UITextView *)textView
{
    ...
    {
        AddViewController *pAddCntrl = (AddViewController *) pAddEditCntrl;
        pAddCntrl.pNewItem.notes = textView.text;
       
    }
    else
    {
        pDlg.editItem.notes = textView.text;
    }
