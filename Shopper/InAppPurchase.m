...
-(void) completeTransaction:(SKPaymentTransaction *) transaction
{
    ...
    if ([transaction.payment.productIdentifier isEqualToString:@"com.rekhaninan.openhouses_unlocked"])
    {
...
-(void) restoreTransaction:(SKPaymentTransaction *) transaction
{
    ...
    if ([transaction.payment.productIdentifier isEqualToString:@"com.rekhaninan.openhouses_unlocked"])
    {
        ...
        [pDlg setPurchsd];
        bIgnoreAlertVwClck = true;
        UIAlertView *pAvw = [[UIAlertView alloc] initWithTitle:@"Success" message:@"Restored OpenHouses feature to add unlimited number of cars" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
...
-(InAppPurchase *) init
{
    ...
    NSSet * productIdentifiers = [NSSet setWithObjects:
                                  @"com.rekhaninan.openhouses_unlocked", nil];
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
    ...
    switch (buttonIndex)
    {
        case YES_TO_PAY:
        {
            ...
            if (bPurchase)
            {
                NSLog(@"Purchasing OpenHouses unlock");
                [[SKPaymentQueue defaultQueue] addPayment:payment];
            }
            else
            {
                 NSLog(@"Restoring OpenHouses unlock");
